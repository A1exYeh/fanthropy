...
export const Index = () => {
  return (
    <>
      <section className="bg-primary min-h-[50vh] h-fit flex justify-center items-center drop-shadow-md">
      ...
      <section className="bg-background min-h-[50vh] h-fit flex justify-center items-center drop-shadow-md p-24">
        <div className="flex flex-col justify-start items-center w-full h-full px-8 gap-12 ">
          ...
          <div className='flex flex-row justify-center items-start gap-8 '>
            <div className='p-4 rounded-xl bg-red-400 font-medium flex-1'>
